      ...
      *                                                                *
      *  NEW RANGES ADDED FOR HIGHER SALES RATES THEN IN PREVIOUS VER. *
      *                                                                *
      ******************************************************************
...
*********
       01  MGMT-RANGE        PIC 9(7)V99.
           ...
           88  M-RANGE6           VALUES ARE 500001 THRU 900000.
*********
*********
*********
       01  MGMT-RATE-TABLE.
       ...
       01  MGMT-RATE-REDEFINED REDEFINES MGMT-RATE-TABLE.
           05  MGMT-RATE-OCCURS OCCURS 6 TIMES INDEXED BY MGMT-IX.
               10  MGMT-RATE    PIC SV999.
*********
*********
*********
       01  SALES-RANGE         PIC 9(7)V99.
           ...
           88  S-RANGE6        VALUES ARE 100001 THRU 500000.
*********
*********
*********
       01  SALES-RATE-TABLE.
           ...
           05  FILLER          PIC SV99  VALUE  +.20.
       01  SALES-RATE-REDEFINED REDEFINES SALES-RATE-TABLE.
           05  SALES-RATE-OCCURS OCCURS 6 TIMES INDEXED BY SALES-IX.
