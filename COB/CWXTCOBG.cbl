      ...
      ******************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT REPORT2-FILE  ASSIGN TO RPTFILE2.
      ...
      *     BLOCK CONTAINS 0 RECORDS
           RECORDING MODE IS F.
       01  REPORT2-RECORD.
           05   REP2-NAME               PIC X(15).
           05   REP2-REGION             PIC X(5).
           05   REP2-TYPE               PIC X(1).
           05   REP2-HIRE-MM            PIC 9(2).
           05   REP2-HIRE-DD            PIC 9(2).
           05   REP2-HIRE-YY            PIC 9(2).
           05   REP2-YEARS-OF-SERVICES  PIC 9(2).
           05   REP2-SALARY             PIC S9(5)V99 COMP-3.
           05   REP2-OT                 PIC S9(5)V99 COMP-3.
           05   REP2-COMM               PIC S9(5)V99 COMP-3.
           05   REP2-TOTAL              PIC S9(5)V99 COMP-3.
           05   FILLER                  PIC X(35).
...
********
********  FIELDS USED BY CALLED PROGRAM CWXTSUBG TO CALCULATE
...
*********
       2000-PROCESS-HOURLY.
           ...
           CALL 'CWXTDATG' USING END-OF-MONTH-SW
                                 YRS-OF-SERVICE
                                 TODAYS-DATE
                                 WA-EMP-HIRE-DATE.
...
*********  RETURNED FROM CWXTSUBG, IT IS STORED IN A HOLD-TABLE.  THE
